...
public final class CalendarUtils {
    ...
    public static final DateTimeFormatter API_DATE_FORMATTER = DateTimeFormatter
            .ofPattern(JunoApiFormats.API_DATE_PATTERN);
    public static final DateTimeFormatter API_DATE_TIME_FORMATTER = DateTimeFormatter
            .ofPattern(JunoApiFormats.API_DATE_TIME_PATTERN);
